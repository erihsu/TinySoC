...
set structArgument0 [list 32 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "axis<32>" "struct axis" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set Dims1 [list 0]
set Interface1 "wire"
set DataType1 "[list ap_uint 4 ]"
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "enable"
set BitWidth2 "8"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
