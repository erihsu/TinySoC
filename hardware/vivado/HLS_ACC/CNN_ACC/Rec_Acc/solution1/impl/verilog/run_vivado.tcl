...
if { !$add_io_buffers } {
    lappend synth_args -no_iobuf -mode out_of_context
}
if { [llength $synth_args] } {
    set_property -name {STEPS.SYNTH_DESIGN.ARGS.MORE OPTIONS} -value $synth_args -objects [get_runs synth_1]
}
