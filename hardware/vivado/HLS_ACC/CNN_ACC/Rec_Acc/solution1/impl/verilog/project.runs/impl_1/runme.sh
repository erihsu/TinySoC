...
HD_PWD='/home/eric/Documents/for_competition/HLS_ACC/CNN_ACC/Rec_Acc/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lenet5.tcl -notrace
