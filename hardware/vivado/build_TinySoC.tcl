...
set proj_dir "[file normalize "$origin_dir/output"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../hls/Binary/40M"] [file normalize "$origin_dir/IPs"] [file normalize "$origin_dir/../hls/HLS_ACC"]" $obj
