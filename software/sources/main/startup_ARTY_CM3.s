...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     UART0_Handler             ; Handler
                DCD     GPIO1_Handler             ; GPIO 1 Handler
                DCD     NUM0_Handler             ; QUAD SPI 0 (Arty board) Handler
                DCD     NUM1_Handler         ; DAPLink board QUAD SPI 0 Handler
                DCD     NUM2_Handler          ; DAPLink board SPI 0 Handler
                DCD     NUM3_Handler      ; DAPLink board QUAD SPI XIP Handler
                DCD     NUM4_Handler            ; Used as steady state GPIO input, not IRQ
                DCD     NUM5_Handler               ; Unused
                DCD     NUM6_Handler               ; Unused
                DCD     NUM7_Handler              ; Unused
                DCD     NUM8_Handler              ; Unused
                DCD     NUM9_Handler              ; Unused
...
Default_Handler PROC
                ...
                EXPORT NUM0_Handler              [WEAK]
                EXPORT NUM1_Handler          [WEAK]
                EXPORT NUM2_Handler           [WEAK]
                EXPORT NUM3_Handler       [WEAK]
                EXPORT NUM4_Handler             [WEAK]
                EXPORT NUM5_Handler                [WEAK]
                EXPORT NUM6_Handler                [WEAK]
                EXPORT NUM7_Handler               [WEAK]
                EXPORT NUM8_Handler               [WEAK]
                EXPORT NUM9_Handler               [WEAK]
