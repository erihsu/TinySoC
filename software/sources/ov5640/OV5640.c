...
//���ܣ���OV7660�Ĵ���
//���أ�1-�ɹ�   0-ʧ��
uchar rdOV5640Reg(u16 regID, uchar *regDat)
{
        //ͨ��д�������üĴ�����ַ
...
void    JPEG_5MP(void)
{
    ...
    */
    ...
    wrOV5640Reg(0x4300, 0x31);//YUV422��ʽѡ��
...
{
    int ov_id = 0;
    print("OV5640_init Begin!\n");
    ov5640_probe();
    print("OV5640_probe Done!\n");
    ov5640_get_para_chip_id(&ov_id);
    print("ov5640_get_para_chip_id Done!\n");

    ov5640_power_on();
    print("ov5640_power_on Done!\n");
    ov5640_setting_preview(30);//֡��
    print("ov5640_setting_preview Done!\n");
...
{
    wrOV5640Reg(0x4300, 0x03);//RGB��ʽѡ��
